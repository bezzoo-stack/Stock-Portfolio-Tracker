...
public class Deposit extends javax.swing.JFrame {
    ...
    // No-arg constructor (for NetBeans preview)
    public Deposit() {
        initComponents();
    ...
    public Deposit(String username) {
        this.loggedInUsername = username;   // store logged-in user
        initComponents();
        setLocationRelativeTo(null);
        showBalance();                     // display balance for this user
    }

    // Display user balance in the JLabel
    private void showBalance() {
        if (loggedInUsername != null && jLabel6 != null) {
            double balance = DatabaseConnection.getUserBalance(loggedInUsername);
            jLabel6.setText("₱ " + String.format("%.2f", balance));
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(541, 6, -1, -1));
        ...
        jPanel1.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, -1, -1));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(535, 155, -1, -1));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 50, 690, 620));
        ...
        getContentPane().add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 60, 690, 620));
        ...
        getContentPane().add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 70, 690, 620));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Update the label
        jLabel6.setText("₱ " + String.format("%.2f", newBalance));

        JOptionPane.showMessageDialog(this, "Deposit Successful!");
        Transaction t = new Transaction(loggedInUsername);
        t.setVisible(true);
        this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Transaction t = new Transaction(loggedInUsername);  // pass username
        t.setVisible(true);
        this.dispose();
